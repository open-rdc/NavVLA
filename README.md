...
- 学習設定: [training/config/train.yaml](/home/kyo/NavVLA/training/config/train.yaml:1)
- モデル設定: [training/config/network.yaml](/home/kyo/NavVLA/training/config/network.yaml:1)
- データセット設定: [training/config/dataset.yaml](/home/kyo/NavVLA/training/config/dataset.yaml:1)
...
- [deployment/launch/navigation.launch.py](/home/kyo/NavVLA/deployment/launch/navigation.launch.py:1)

設定ファイル:

- [deployment/config/nav.yaml](/home/kyo/NavVLA/deployment/config/nav.yaml:1)
- [deployment/config/preprocess.yaml](/home/kyo/NavVLA/deployment/config/preprocess.yaml:1)
...
- 本リポジトリ独自コード: MIT
- `OmniVLA/`: [OmniVLA/LICENSE](/home/kyo/NavVLA/OmniVLA/LICENSE:1) に従う
